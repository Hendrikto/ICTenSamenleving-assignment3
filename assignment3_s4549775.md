...
Where learning is defined as improving performance on a specific task without being explicitly told what to do. This improvement is achieved by looking at some kind of data. This does not exclude being taught. Only giving explicit instructions like "if a then do b" is not allowed. [@10.1147] The definition also does not prevent having such rules as an outcome of learning, as long as the leaning entity comes up with them on its own.
